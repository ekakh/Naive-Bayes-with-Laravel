            ...
            <form action="{{ route('kriteria.store') }} " method="POST" enctype='multipart/form-data'>
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <select name="jenis_kriteria" class="form-control @error('jenis_kriteria') is-invalid @enderror" value="{{old('jenis_kriteria')}}">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="kode_kriteria" class="form-control @error('kode_kriteria') is-invalid @enderror" placeholder="Kode Kriteria" value="{{old('kode_kriteria')}}">
                  @error('kode_kriteria')
                  <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="nama_kriteria" class="form-control @error('nama_kriteria') is-invalid @enderror" placeholder="Nama Kriteria" value="{{old('nama_kriteria')}}">
                  @error('nama_kriteria')
                  <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
