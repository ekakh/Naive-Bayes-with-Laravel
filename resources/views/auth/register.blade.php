            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="roles_id" class="col-md-4 col-form-label text-md-end">{{ __('roles_id') }}</label>

                            <div class="col-md-6">
                                <input id="roles_id" type="text" class="form-control @error('roles_id') is-invalid @enderror" name="roles_id" value="{{ old('roles_id') }}" required autocomplete="roles_id" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="telepom" class="col-md-4 col-form-label text-md-end">{{ __('Telepon') }}</label>
